#!/usr/bin/env python3
"""
Script pour tester l'analyse IA avec une vraie image
"""
...
def test_real_image_analysis():
    """Teste l'analyse IA avec une vraie image"""
    print("Test d'analyse IA avec vraie image")
    print("=" * 50)
    
    # Utiliser une image publique accessible
    ...
    print(f"Image test: {test_image_url}")
